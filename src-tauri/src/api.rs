...
/// 前端字节版入参：name 仅用于临时命名；data 是 PDF 原始字节
...
/// 统一合并命令
/// - inputs: string[] 或 {name,data}[]
/// - output: 目标路径，如 "C:\\Users\\ADMIN\\Downloads\\merged.pdf"
#[tauri::command]
...
/// 生成 qpdf 合并参数：qpdf --empty --pages f1 f2 ... -- out.pdf
